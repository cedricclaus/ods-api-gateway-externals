...
To build the final jar and optimize the OdsApiGatewayExternals application for production, run:
...
Then navigate to [http://localhost:8380](http://localhost:8380) in your browser.
